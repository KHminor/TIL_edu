    ...
    <div className="App">
      ...
      <Routes>
        <Route
          ...
          element={
            <>
              <div className="main-bg"> {/* 배경사진 */} </div>{" "}
              <div>
                <button
                  onClick={() => {
                    setLoading(true);
      ...
      <div> {loading === true ? <Loding /> : null} </div>
      <div
        style={{
          display: "grid",
    ...
    >
      ...
      >
        <img
          ...
          src={"https://codingapple1.github.io/shop/shoes" + dataId + ".jpg"}
          alt=""
        />
        <p
          style={{
        ...
        <p> {props.data.content} </p> <p> {props.data.price} </p>{" "}
      </div>{" "}
    </div>
  );
}
...
function Loding() {
  return (
    ...
    >
      <img
        src="https://mblogthumb-phinf.pstatic.net/MjAyMDExMTJfMTgg/MDAxNjA1MTkxMjUwMzk4.BW7kx0zOQyxI57lwIxcYu40P1uicXhVNXQRSGegLuugg.RLMpOQkNfd72xWh8CJFLQz4ZwyGuZmWrDSdH8dfzArUg.GIF.bom____bom/90s_gif_(17).gif?type=w800"
        alt=""
      />
    </div>
  );
